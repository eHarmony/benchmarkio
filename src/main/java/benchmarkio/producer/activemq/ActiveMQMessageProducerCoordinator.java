...
public class ActiveMQMessageProducerCoordinator extends MessageProducerCoordinator {
    ...
    public ActiveMQMessageProducerCoordinator(final String host,
                                              final int port,
                                              final String topic,
    ...
    public MessageProducer createProducer(final long numberOfMessagesToProduce) {
        return new ActiveMQMessageProducer(host, port, topic, message, numberOfMessagesToProduce, durable);
    }
}
